...
class Ordered_product_model extends MY_Model {
    ...
    public function get_ordered_product_full_info_by_cart_id($cartId) {
        $this->db->select(
                'pp_ordered_product.ordrd_prdct_id as "orderedProductId", pp_ordered_product.ordrd_prdct_count as "orderedProductCount", pp_ordered_product.ordrd_prdct_crt_id, pp_possible_size_for_product.psfp_name as "possibleSizeForProductName", pp_possible_size_for_product.psfp_product_id, pp_product.prdct_id as "productId", pp_product.prdct_name as "productName", pp_product.prdct_price as "productPrice", pp_user.usr_nick as "creatorNick" ');
        $this->db->from('pp_ordered_product');
        $this->db->where('pp_ordered_product.ordrd_prdct_crt_id', $cartId);
        $this->db->join('pp_possible_size_for_product', 'pp_ordered_product.ordrd_prdct_psfp_id = pp_possible_size_for_product.psfp_id');
        $this->db->join('pp_product', 'pp_possible_size_for_product.psfp_product_id = pp_product.prdct_id');
        $this->db->join('pp_user', 'pp_product.prdct_creator = pp_user.usr_id');
    ...
    public function get_all_ordered_products_price_including_by_cart_id($cartId) {
        $this->db->select(
                'pp_ordered_product.ordrd_prdct_id as "orderedProductId", pp_ordered_product.ordrd_prdct_count as "orderedProductCount", pp_ordered_product.ordrd_prdct_crt_id, pp_possible_size_for_product.psfp_product_id, pp_product.prdct_id as "productId", pp_product.prdct_price as "productPrice" ');
        $this->db->from('pp_ordered_product');
        $this->db->where('pp_ordered_product.ordrd_prdct_crt_id', $cartId);
        $this->db->join('pp_possible_size_for_product', 'pp_ordered_product.ordrd_prdct_psfp_id = pp_possible_size_for_product.psfp_id');
        $this->db->join('pp_product', 'pp_possible_size_for_product.psfp_product_id = pp_product.prdct_id');
