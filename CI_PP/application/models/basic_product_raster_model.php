...
class Basic_product_raster_model extends MY_Model {
     ...
     */
    protected $_table = 'pp_basic_prod_raster_representation';
    ...
    public function get_single_basic_product_raster_by_basic_product_id_and_pov_id($basicProductId, $povId) {
        ...
        $query = $this->db->query('SELECT bprr.* FROM ' . $this->_table . ' bprr WHERE bprr.bs_prdct_rstr_rep_basic_product_point_of_view_id = ' . $povId . ' AND bprr.bs_prdct_rstr_rep_basic_product_id = ' . $basicProductId . ' LIMIT 1;');
