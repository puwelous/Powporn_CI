...
class Order_model extends MY_Model {
    ...
    public function get_all_by_user_id($userId) {
        ...
        $query = $this->db->query('SELECT ' . $this->_table . '.* FROM ' .$this->_table . ' WHERE ' . $this->_table . '.ordr_assigned_cart IN ( SELECT pp_cart.crt_id FROM pp_cart WHERE pp_cart.crt_ordering_person_id = ' . $this->db->escape($userId) . ' );');
