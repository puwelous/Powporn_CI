...
class Product_model extends MY_Model {
    ...
    public function get_product($productId) {
        ...
        $loaded_product->instantiate(
                $selected_product->prdct_name, $selected_product->prdct_price, $selected_product->prdct_description, $selected_product->prdct_sex, $selected_product->prdct_acceptance_status, $selected_product->prdct_creator, $selected_product->prdct_basic_product_id, $selected_product->prdct_photo_url);
    ...
    public function get_any_single_product() {
        ...
        $query = $this->db->query('SELECT * FROM pp_product LIMIT 1;');
     ...
     * @param int $limit
     *  Maximal number of results retrieved
     * @param int $offset
     *  Offset where to start data retrieval at
     * @return null|Product_model
     *  Either null if there are no accepted products in database or array of all accepted product models
     */
    public function get_accepted_products($limit, $offset) {
        return $this->get_products_by_status(Product_model::PRODUCT_STATUS_ACCEPTED, $limit, $offset);
    }
     ...
     */
    public function get_proposed_products($limit, $offset) {
        return $this->get_products_by_status(Product_model::PRODUCT_STATUS_PROPOSED, $limit, $offset);
    }
     ...
     */
    private function get_products_by_status($status, $limit = 10, $offset = 0) {
