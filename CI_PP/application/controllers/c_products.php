...
class C_products extends MY_Controller {
    ...
    public function index() {
        ...
        $products = $this->product_model->get_accepted_products(null, null);
...
//            log_message('debug', print_r($sup_povs, true));
    ...
    public function get_accepted() {
        ...
        // load product definitions
        $products = $this->product_model->get_accepted_products(9,0);
        //$products = $this->product_model->get_all_products(); //TODO: change to the line of code above!
        ...
        $string = $this->parser->parse('templates/products', $data, TRUE);
        echo $string;
    }
