...
class MY_Controller extends CI_Controller {
    ...
    /**
     * Template path to be rendered if user is in UCREATE section
     */
    const UCREATE_TEMPLATE_PATH = 'templates/ucreate';
    ...
    protected function load_header_templates(&$template_data) {
        ...
        $this->load_ucreate_template($template_data);
    }
    ...
    /**
     * Loads additional ucreate template into passed template data array.
     * 
     * @param array $template_data
     */
    private function load_ucreate_template(&$template_data) {

        if (strpos(current_url(), 'ucreate') !== false) {
            $template_data['ucreate_additional_template'] = $this->parser->parse(constant('MY_Controller::' . 'UCREATE_TEMPLATE_PATH'), array(), TRUE);
        }
    }
